...
pub fn check_symbol_string(candidate: &str, symbol: &str) -> bool {
    candidate.contains(symbol)
}

pub fn check_matching_pair(candidate: &str, symbol1: &str, symbol2: &str) -> bool {
    candidate.contains(symbol1) && candidate.contains(symbol2)
}
